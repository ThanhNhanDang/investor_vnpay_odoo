...
export class CustomRenderContainer extends Component {
...
const renderService = {
    ...
    start() {
        ...
        let elem, resolver;
        registry.category("main_components").add("CustomRenderContainer", {
            Component: CustomRenderContainer,
            props: {
...
registry.category("services").add("custom_renderer", renderService);
